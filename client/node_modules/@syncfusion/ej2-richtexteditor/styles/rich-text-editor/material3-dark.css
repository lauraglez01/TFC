...
.e-richtexteditor .e-source-content .e-content table th.e-cell-select.e-multi-cells-select::after {
  background-color: rgba(var(--color-sf-primary), 0.11);
  content: "";
  position: absolute;
  top: 0;
  left: 0;
...
.e-richtexteditor ::-moz-selection {
...
.e-bigger .e-richtexteditor .e-toolbar {
  border-radius: 4px 4px 0 0;
}
.e-bigger .e-richtexteditor .e-toolbar .e-toolbar-items {
  border-radius: 4px 4px 0 0;
}
